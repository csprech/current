...
const MODELS_CACHE_KEY = "current-models-cache";
...
export function ModelSearchDialog({
  ...
  const handleRefresh = useCallback(async () => {
    ...
    try {
      ...
      localStorage.removeItem("current-schema-cache");
              ...
              {showClearOption && onClearSelection && (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-neutral-200 group-hover:text-neutral-100">Remove fallback</span>
                  </div>
