...
export function TutorialMessage({ message, position = "center", waitForClick = false, links }: TutorialMessageProps) {
  ...
  return (
    <div role="status" aria-live="polite" className={`absolute ${positionClasses[position]} max-w-sm px-6 py-4 current-transient-surface rounded-lg shadow-xl transition-opacity duration-300 opacity-100 pointer-events-auto`}>
